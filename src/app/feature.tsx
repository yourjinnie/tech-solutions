...
const FEATURES = [
  ...
  {
    icon: LockClosedIcon,
    title: "Grow with Right Marketing",
    children:
  ...
  return (
    <section className="py-28 px-4">
      <div className="container mx-auto mb-20 text-center">
        ...
        >
         We specialize in crafting tech solutions tailored to businesses, optimizing your operations for efficiency. Elevate your brand with our targeted ads and marketing strategies, designed to amplify your reach and impact.
        </Typography>
      </div>
